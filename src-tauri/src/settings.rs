...
pub struct Settings {
    ...
    pub editor_code_completion: bool,
...
impl LegacySettings {
    fn with_defaults() -> Self {
        ...
        Self {
            ...
            editor_code_completion: defaults.editor_code_completion,
    ...
    fn into_parts(self) -> (Settings, Option<String>, bool) {
        ...
        (
            Settings {
                ...
                editor_code_completion: self.editor_code_completion,
...
pub fn get_settings_view() -> SettingsView {
    ...
    SettingsView {
        ...
        editor_code_completion: settings.editor_code_completion,
