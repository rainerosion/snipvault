...
fn main() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            snipvault::commands::list_sync_conflicts,
            snipvault::commands::get_sync_conflict_review,
            snipvault::commands::resolve_sync_conflict,
            snipvault::commands::get_device_identity_status,
            snipvault::commands::rotate_device_identity,
