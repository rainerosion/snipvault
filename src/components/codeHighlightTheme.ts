...
export const darkHighlightStyle = HighlightStyle.define([
  ...
  { tag: t.keyword, color: DARK_SYNTAX_COLORS.keyword },
  {
    ...
    color: DARK_SYNTAX_COLORS.name,
  },
  {
    tag: [t.function(t.variableName), t.function(t.propertyName)],
    color: DARK_SYNTAX_COLORS.functionName,
  },
  ...
  },
  {
    ...
    color: DARK_SYNTAX_COLORS.punctuation,
  },
  {
    tag: [t.meta, t.comment],
    color: DARK_SYNTAX_COLORS.comment,
    fontStyle: "italic",
  },
  { tag: t.strikethrough, textDecoration: "line-through" },
  {
    tag: t.link,
    color: DARK_SYNTAX_COLORS.string,
    textDecoration: "underline",
  },
  { tag: t.heading, fontWeight: "bold", color: DARK_SYNTAX_COLORS.type },
  {
    tag: [t.atom, t.bool, t.special(t.variableName)],
    color: DARK_SYNTAX_COLORS.keyword,
  },
  {
...
export const lightHighlightStyle = HighlightStyle.define([
  ...
  {
    tag: [t.name, t.deleted, t.character, t.propertyName, t.macroName],
    color: LIGHT_SYNTAX_COLORS.name,
  },
  {
    tag: [t.function(t.variableName), t.function(t.propertyName)],
    color: LIGHT_SYNTAX_COLORS.functionName,
  },
  ...
  },
  {
    ...
    color: LIGHT_SYNTAX_COLORS.plain,
  },
  {
    tag: [
      t.typeName,
    ...
    color: LIGHT_SYNTAX_COLORS.type,
  },
  {
    tag: [
      t.operator,
    ...
    color: LIGHT_SYNTAX_COLORS.punctuation,
  },
  {
    tag: [t.meta, t.comment],
    color: LIGHT_SYNTAX_COLORS.comment,
    fontStyle: "italic",
  },
  { tag: t.strikethrough, textDecoration: "line-through" },
  {
    tag: t.link,
    color: LIGHT_SYNTAX_COLORS.string,
    textDecoration: "underline",
  },
  { tag: t.heading, fontWeight: "bold", color: LIGHT_SYNTAX_COLORS.type },
  {
    tag: [t.atom, t.bool, t.special(t.variableName)],
    color: LIGHT_SYNTAX_COLORS.keyword,
  },
  {
    tag: [t.processingInstruction, t.string, t.inserted],
    color: LIGHT_SYNTAX_COLORS.string,
